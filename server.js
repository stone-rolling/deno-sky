...
const words = ["しりとり", "りんご", "ごま", "まりも", "もも", "もうし", "しんじ", "じんじ",
               ...
               "ねぎ", "はさみ", "のこぎり", "まぐろ", "ものさし", "めだか", "にく","くま"];
...
function handleSpecialCases(word) {
  ...
  if (word.slice(-1) === "ぁ") return word.slice(0, -1) + "あ";
  if (word.slice(-1) === "ぃ") return word.slice(0, -1) + "い";
  if (word.slice(-1) === "ぅ") return word.slice(0, -1) + "う";
  if (word.slice(-1) === "ぇ") return word.slice(0, -1) + "え";
  if (word.slice(-1) === "ぉ") return word.slice(0, -1) + "お";
